...
KART.L_enUS = {
    ...
    LC_LOOTMASTER_OTHER    = "Your Lootmaster field names someone else, so their client sends the raid-wide settings, not yours — and it has not done so yet. Until it does, every raider falls back to their own vote buttons, minimum quality and roll setting. Make sure the named lootmaster is in the raid and running KART.",
