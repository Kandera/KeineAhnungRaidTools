...
KART.L_enUS = {
    ...
    LC_DESC_ROLLS_ENABLED  = "Every eligible raider automatically rolls a 1-100 value (like RCLootCouncil), shown as its own column in the council panel. Purely informational — never drives an assignment automatically. Only takes effect for the raid when you are the lootmaster.",
    ...
    LC_STATUS_DROPS        = "Messages refused here: %d sender, %d not in group, %d unknown item, %d unknown token -- own sends rejected: %d (%d throttled), held while restricted: %d, dropped in them: %d",
