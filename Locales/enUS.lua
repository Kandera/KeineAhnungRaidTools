...
KART.L_enUS = {
    ...
    LC_SET_LOOTMASTER_HINT = "This player wins every roll and trades each item to whoever the council picks. Overrides their own Auto-Pass setting. Character name OR Northern Sky Raid Tools nickname — with a nickname this applies to every character sharing it. Whoever is named here also owns the raid-wide settings in this box — only their client sends them to the raid. Leave empty if nobody is handing out loot this way.",
