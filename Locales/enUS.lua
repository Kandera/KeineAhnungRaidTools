...
KART.L_enUS = {
    ...
    LC_BTN_CANCEL          = "Close",
    LC_BTN_CLOSE_SESSION   = "Close Session",
    LC_DESC_CLOSE_SESSION  = "Ends the Loot Council session for the whole raid and discards every item still open. Only the lootmaster can do this.",
    LC_CLOSE_SESSION_CONFIRM = "End the Loot Council session? Every item still open is discarded.",
