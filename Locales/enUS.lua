...
KART.L_enUS = {
    ...
    LC_SET_LOOTMASTER_HINT = "This player wins every roll and trades each item to whoever the council picks. Overrides their own Auto-Pass setting. Leave empty if nobody is handing out loot this way.",
