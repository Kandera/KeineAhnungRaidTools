...
KART.L_enUS = {
    ...
    DESC_RL_RC_REASON = "After you decline a ready check, KART offers a small window to send a reason (Bio, Drink, 1 Min or free text) to the raid. Switch this off and declining stays a plain decline.",
