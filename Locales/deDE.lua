...
KART.L_deDE = {
    ...
    LC_BTN_CLOSE_SESSION   = "Session beenden",
    LC_DESC_CLOSE_SESSION  = "Beendet die Loot-Council-Session für den ganzen Raid und verwirft alle noch offenen Items. Das kann nur der Lootmaster.",
    LC_CLOSE_SESSION_CONFIRM = "Loot-Council-Session beenden? Alle noch offenen Items werden verworfen.",
