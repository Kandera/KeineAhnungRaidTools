...
KART.L_deDE = {
    ...
    DESC_RL_RC_REASON = "Nachdem du einen Ready-Check abgelehnt hast, bietet KART ein kleines Fenster an, um dem Raid einen Grund zu schicken (Bio, Trinken, 1 Min oder freier Text). Aus heißt: Ablehnen bleibt einfach Ablehnen.",
