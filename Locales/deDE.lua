...
KART.L_deDE = {
    ...
    LC_SET_LOOTMASTER_HINT = "Dieser Spieler gewinnt jede Roll und tauscht jedes Item mit demjenigen, den das Council auswählt. Überschreibt dessen eigene Auto-Pass-Einstellung. Leer lassen, wenn niemand Loot auf diese Weise verteilt.",
