...
KART.L_deDE = {
    ...
    LC_STATUS_DROPS        = "Hier verworfene Nachrichten: %d Absender, %d nicht in der Gruppe, %d unbekanntes Item, %d unbekanntes Token -- eigene Sendungen abgelehnt: %d (%d Drossel), wegen Sperre zurückgehalten: %d, dabei verworfen: %d",
