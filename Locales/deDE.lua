...
KART.L_deDE = {
    ...
    LC_DESC_AUTOPASS       = "Sobald eine Loot-Roll beginnt, passen alle KART-Nutzer sofort — verhindert versehentliche Need/Gier/Transmog-Klicks während der Council-Abstimmung.",
    LC_SET_VOTE_TIMER      = "Abstimmungs-Timer (Sek)",
    LC_DESC_VOTE_TIMER     = "Wie viele Sekunden Raider Zeit haben, ihre Stimme abzugeben, bevor das Council-Panel abschließt.",
    ...
    LC_DESC_COUNCIL        = "Spieler in dieser Liste sehen das Council-Panel und können als Vollmitglieder abstimmen, ohne Assistenten-Rang zu benötigen.",
    LC_SET_COUNCIL_HINT    = "Raidleiter ist immer automatisch im Council. Assistenten nicht.",
    LC_BTN_TOGGLE          = "Session umschalten",
    LC_DESC_TOGGLE         = "Loot Council für die aktuelle Raid-Session manuell aktivieren oder deaktivieren.",
    ...
    LC_DESC_MIN_QUALITY    = "Items unterhalb dieser Qualität werden vom Loot Council komplett ignoriert — es gilt das normale WoW-Würfelfenster. Verhindert unnötige Abstimmungs-Popups bei Trash und geringwertigen Items.",
