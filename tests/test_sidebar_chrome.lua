...
do
    ...
    T.eq(KART.InGameChangelog[1].version, "4.2.0", "first block is the current release")
    T.truthy(KART.InGameChangelog[1].entries[1]:find("fleeting potion", 1, true),
        "in-game 4.2.0 list starts with fleeting bag counts")
