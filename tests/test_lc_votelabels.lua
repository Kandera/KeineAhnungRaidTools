...
do
    ...
    F.Drop(sim, 50, F.GLOVES)

    -- Time passes -- past the orphan grace, which is what makes the stamp dangerous, but not so far
    -- that the roll itself ends: an ended roll clears the stamp along with everything else, and the
